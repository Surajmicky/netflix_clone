import {
  ...
  import { API_KEY, TMDB_BASE_URL } from "../utils/keys";
  ...
  export const getGenres = createAsyncThunk("netflix/genres", async () => {
    const {
      ...
      "https://api.themoviedb.org/3/genre/movie/list?api_key=cc2281e8de9a5947c3ce35e89ff2aab7"
    );
    return genres;
  });
  ...
  export const { setGenres, setMovies,likedMovies } = NetflixSlice.actions;
